...
public class TmHelp extends MainTM {
	...
	private static String setSleepAnimationHelpMsg = ChatColor.GOLD + "/" + CMD_TM + " " + CMD_SET_SLEEPANIMATION
			+ " [on|off|toggle|instant] <world> " + ChatColor.GRAY + "Shortcut for nightSkipMode = animation/default on a world. Activates sounds, text and particles during the night-skip sequence.";
